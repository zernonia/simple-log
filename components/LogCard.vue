...
<template>
  <div
    class="p-3 sm:p-4 md:p-6 mb-4 md:mb-6 w-full flex md:w-120 bg-gray-50 rounded-xl hover:shadow-md transition-all duration-300 ease-in-out"
    v-auto-animate
  >
    <div v-if="mini" class="flex items-center justify-between w-full">
      ...
      <p class="truncate text-sm px-4 flex-grow text-light-400">
        <span class="font-semibold mr-2 text-gray-800">{{ data.name }}</span>
